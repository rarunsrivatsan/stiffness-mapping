classdef stiffness_map_gen
    ...
    methods
        ...
        function obj=space_quiver(obj,t)
            count=1;
            [tool(:,:,1),em(:,:,1)]=fetchTF(obj.trak.sub);
            obj.fHandle=figure;
            emFig=quiver3(em(1,4),em(2,4),em(3,4),em(1,1),em(2,1),em(3,1),'r');
            hold on;
            toolFig=quiver3(tool(1,4),tool(2,4),tool(3,4),tool(1,1),tool(2,1),tool(3,1),'b');
